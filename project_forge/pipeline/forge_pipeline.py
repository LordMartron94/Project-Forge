...
from project_forge.pipeline.initialize_frameworks import InitializeFrameworks
...
class ForgePipeline(AbPipeline):
    ...
    def build_pipeline(self):
        ...
        self._add_step(InitializeFrameworks(self._logger, self._user_input_handler))
